<div class="modal-content">            
    ...
    {!! Form::open(['route'=>'monthlyIncome.create', 'method' => 'post', 'files' => 'true','class'=>'ajax-form']) !!}
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Range" name="range" value="{{ isset($data->id) ? $data->range : Null }}" class="form-control" required >
                    </div>
                </div>
