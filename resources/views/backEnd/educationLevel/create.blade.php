<div class="modal-content">            
    <div class="modal-header">
        <h5 class="modal-name" > {{ isset($data->id) ? 'Edit Education Level' : 'Add Education Level' }} </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div> 
    {!! Form::open(['route'=>'education_level.create', 'method' => 'post', 'files' => 'true','class'=>'ajax-form']) !!}
