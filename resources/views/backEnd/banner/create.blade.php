<div class="modal-content">            
    <div class="modal-header">
        <h5 class="modal-title" > {{ isset($data->id) ? 'Edit Banner' : 'Add Banner' }} </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div> 
    {!! Form::open(['route'=>'banner.create', 'method' => 'post', 'files' => 'true','class'=>'ajax-form']) !!}
            ...
            <div class="row">
               ...
               <!-- Link -->
                <div class="col-12 col-sm-12 col-md-4">
                    <div class="form-group">
                        <label>Link </label>
                        <input type="text" placeholder="Link Here if Exists" name="link" value="{{ isset($data->id) ? $data->link : Null }}" class="form-control" >
                    </div>
                </div>                
