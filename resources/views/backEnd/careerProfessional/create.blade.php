<div class="modal-content">            
    <div class="modal-header">
        <h5 class="modal-name" > {{ isset($data->id) ? 'Edit Career Professional' : 'Add Career Professional' }} </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div> 
    {!! Form::open(['route'=>'careerProfessional.create', 'method' => 'post', 'files' => 'true','class'=>'ajax-form']) !!}
