<div class="modal-content">            
    <div class="modal-header">
        <h5 class="modal-name" > {{ isset($data->id) ? 'Edit' : 'Add' }} Religious</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div> 
    {!! Form::open(['route'=>'religious.create', 'method' => 'post', 'files' => 'true','class'=>'ajax-form']) !!}
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Name" name="name" value="{{ isset($data->id) ? $data->name : Null }}" class="form-control" required >
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-12 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Short Name" name="short_name" value="{{ isset($data->id) ? $data->short_name : Null }}" class="form-control" required >
                    </div>
                </div>
