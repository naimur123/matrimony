...
<div class="modal-content">            
    ...
    <div class="modal-body row"> 
        ...
        <div class="col-12 col-md-2 text-center">
            ...
            <img src="{{ isset($data->profilePic->image_path) && file_exists($data->profilePic->image_path) ? asset($data->profilePic->image_path) : asset('frontEnd/dummy_user.jpg') }}"  alt="N/A" class="img-fluid img-thumbnail"> 
        </div> 
        ...
        <div class="col-12 row">
            ...
            <div class="col-6 col-lg-4 row mt-2">
                <div class="col-12 col-md-6 font-weight-bold"> Present Country </div>
            ...
            <div class="col-6 col-lg-4 row mt-2">
                <div class="col-12 col-md-6 font-weight-bold"> Permanent Country </div>
        ...
        <div class="col-12 row">
            <div class="col-12 row mt-4">
                ...
                <div class="col-12 col-sm-6 row mt-2">
                    <div class="col-12 col-md-6 font-weight-bold"> Country</div>
