                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="profession_id[]" class="form-control select2" multiple placeholder="Select Profession" id="profession_id">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="education_id[]" class="form-control select2" multiple placeholder="Select Profession" id="education_id">
