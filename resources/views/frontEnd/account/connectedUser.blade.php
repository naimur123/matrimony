                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="row" style="box-shadow: 0px 0px 3px #aaa;padding:10px 0px;height:300;width:100%;">
                            <div class="col-sm-12">
                                <h4 class="text-info">My Connected List</h4>
                            </div>
                                ...
                                <div class="row botder-top" style="margin-top:10px;">
                                    ...
                                    <div class="col-xs-12 col-md-2 connect">
                                        ...
                                        <div class="col-md-12 col-sm-6 text-center p-0">
                                            @if( $user->isConnected($profile->id) )
                                                <span class="label label-success" style="padding-bottom:5px;">Accepted</span><br>
                                            @endif
                                        </div>
                                        <div class="col-md-12 col-sm-6 text-center p-0" style="margin-top:10px;">
